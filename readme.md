👋 I [learn](https://nikiv.dev), [journal](https://nikiv.dev/looking-back) & [code](https://nikiv.dev/code) in [Barcelona](https://nikiv.dev/places). Make [learn-anything.xyz](https://learn-anything.xyz), [solbond.co](https://solbond.co), [1focus.ai](https://1focus.ai) and [things](https://nikiv.dev/focus).
